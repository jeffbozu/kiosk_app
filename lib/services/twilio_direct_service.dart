...
class TwilioDirectService {
  ...
  /// Envía un ticket por WhatsApp directamente a Twilio
  static Future<bool> sendTicketWhatsApp({
    ...
    try {
      ...
      print('📱 Twilio Direct - Enviando mensaje:');
      ...
      if (success) {
        ...
        print('❌ Error enviando WhatsApp via Twilio Direct');
        return false;
      }
    } catch (e) {
      print('❌ Error en TwilioDirectService: $e');
      return false;
    }
  }
  ...
  static Future<bool> _sendToTwilio({
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        print('✅ Mensaje enviado - SID: ${data['sid']}');
        return true;
      } else {
        print('❌ Error de Twilio API: ${response.statusCode}');
        return false;
      }
    } catch (e) {
      print('❌ Error enviando a Twilio: $e');
      return false;
    }
  }
  ...
  static Future<bool> checkTwilioConfig() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('❌ Error en configuración de Twilio: ${response.statusCode}');
        return false;
      }
    } catch (e) {
      print('❌ Error verificando Twilio: $e');
      return false;
    }
  }
  ...
  static Future<bool> testMessage() async {
    try {
      print('🧪 Probando envío directo a Twilio...');
      ...
      if (success) {
        print('✅ Test de Twilio exitoso');
        return true;
      } else {
        print('❌ Test de Twilio falló');
        return false;
      }
    } catch (e) {
      print('❌ Error en test de Twilio: $e');
      return false;
    }
  }
}
