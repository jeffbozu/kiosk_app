...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'es': {
      ...
      'scanToSave': 'Escanee el QR para guardar el ticket en su dispositivo.',
    ...
    'ca': {
      ...
      'scanToSave': 'Escaneja el QR per desar el tiquet al dispositiu.',
      'sendByEmail': 'Enviar per correu electr\u00F2nic',
      'emailSent': 'Tiquet enviat correctament.',
      'close': 'Tancar',
      'closeAndReturn': 'Tancar i tornar',
    ...
    'en': {
      ...
      'scanToSave': 'Scan the QR to save the ticket on your device.',
